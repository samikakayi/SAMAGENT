...
ALIASES: tuple[AppAlias, ...] = (
    AppAlias("tradingview", "TradingView", ("TradingView",),
             ("tradingview", "trading view", "trading-view", "ترەیدینگ ڤیو", "تریدینگ ڤیو", "ترێدینگ ڤیو",
              ...
              # KurdishTTS STT spellings from the user's live session (2026-09-25):
              # «ترێیت ملیۆم لۆ بکەوە», «ترێدینگ ڤیووم», «ترێدین ڤیو», «ترێیت ڤیو»
              "ترێیت ملیۆ", "ترێیت ملیۆم", "ترێیت ڤیو", "ترێیت ڤیوو", "ترێدینگ ڤیوو", "ترەیدینگ ڤیوو",
              "ترێدین ڤیو", "ترەیدین ڤیو", "تریدین ڤیو", "ترەیدینگ فیو", "تریدینگ فیو", "ترێدینگ فیو",
              "ترەیدین", "ترێدین"),
