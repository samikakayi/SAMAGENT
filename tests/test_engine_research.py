"""(Ported from v1 tests/test_research.py.) Entry-trigger and backtest tests, with anti-lookahead as the central concern."""
...
from sam.trading.engine.research import (
    TRIGGER_REGISTRY,
    Trade,
    _resolve_trade,
    backtest_trigger,
